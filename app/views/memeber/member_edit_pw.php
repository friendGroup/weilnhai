...
<body>
    <div id="main">
        ...
        <div id="erjipnl">
            ...
            <div id="rgtpnl">
                <div class="r_tle">
                    <div class="posi">您现在位置：<a href="../index.php">蔚蓝海</a> > 账户管理 > 修改密码</div>
                </div>
                <div id="formzoom">
                    <h1>修改密码</h1>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0">
                        <tbody>
                            <tr>
                                <td colspan="2" style="height:20px;"><span>* 为必填项</span> </td>
                            </tr>
                            <tr>
                                <td align="right" style="width:100px;"><span>*</span> 现有密码：</td>
                                <td><span style=" border-bottom:1px #CCCCCC dashed">
                                  <input name="oldpassword" type="password" class="company_mb_input" id="oldpassword" maxlength="18" />
                                </span></td>
                            </tr>
                            <tr>
                                <td align="right"><span>*</span> 新 密 码：</td>
                                <td><span style=" border-bottom:1px #CCCCCC dashed">
                                  <input name="password" type="password" class="company_mb_input" id="password" maxlength="18" />
                                </span></td>
                            </tr>
                            <tr>
                                <td align="right"><span>*</span> 重复新密码：</td>
                                <td><span style=" border-bottom:1px #CCCCCC dashed">
                                  <input name="password1" type="password" class="company_mb_input" id="password1" maxlength="18" />
                                </span></td>
                            </tr>
                            <tr>
                                <td align="right">&nbsp;</td>
                                <td>
                                    ...
                                    <input type="submit" name="Submit" value="确定修改" class="member_submit" />
                                                          </td>
                            </tr>
                        </tbody>
                    </table>

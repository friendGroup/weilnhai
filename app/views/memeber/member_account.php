...
<body>
    <div id="main">
        ...
        <div id="erjipnl">
            ...
            <div id="rgtpnl">
                <div class="r_tle">
                    <div class="posi">您现在位置：<a href="../index.php">蔚蓝海</a> > 账户管理 > 财务明细</div>
                </div>
                <div id="formzoom">
                    <h1>财务明细</h1>
						<form id="Form1" name="Form1" method="post" action="member_edit_pw.php" onsubmit="return chk_form();">
						  <table width="100%" border="0" cellpadding="4" cellspacing="0" bgcolor="#FFFFFF" class="user_right_box">
                            <tbody>
                              ...
                              <tr>
                                <td height="30" align="left" bgcolor="#FFFFFF" style=" border-bottom:1px #CCCCCC dashed"><!--充值记录 -->
                                     <table border="0" cellpadding="0" cellspacing="0" class="tbllist">
                        <tbody>
                                        <tr>
                                          <td width="120" height="26"><strong>充值号</strong></td>
                                          <td width="123"><strong>日期</strong></td>
                                          <td width="97" align="center"><strong>充值金额</strong></td>
